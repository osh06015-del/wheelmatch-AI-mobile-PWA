...
//
// **이 표가 판정을 내지는 않는다.** "맞다"는 상태가 없고 모름·직접 확인·어긋남
// 셋만 보인다. 어긋남은 가장 먼저, 눈에 띄게 보인다. 덮개 어긋남은 엔진의 덮개
// 조건 규칙이 같은 함수(guardConflicts)로 판정불가를 만들므로, 이 표의 어긋남과
// 상단 판정이 서로 다른 말을 하지 않는다.
//
